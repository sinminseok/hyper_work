...
public class PowerRankService extends AbstractGameRankService {
    ...
    public PowerRankService(GameHistoryRepository gameHistoryRepository, UserRepository userRepository, UserRepository userRepository1, GameHistoryRepository gameHistoryRepository1) {
