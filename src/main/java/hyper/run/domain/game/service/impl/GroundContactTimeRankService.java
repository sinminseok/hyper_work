...
@Service
public class GroundContactTimeRankService implements GameRankService {
    ...
    private List<GameHistory> fetchSortedHistories(Game game) {
        ...
        histories.sort((g1, g2) -> Double.compare(g1.getCurrentGroundContactTime(), g2.getCurrentGroundContactTime())); // 오름차순
        return histories;
    }
