...
function renderDetails(data: PaymentDetail) {
    ...
    const reasonText = document.getElementById('refund-reason') as HTMLTextAreaElement;
...
async function approveRefund(paymentId: string, reason: string) {
...
async function rejectRefund(paymentId: string, reason: string) {
